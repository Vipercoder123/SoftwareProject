...
<td>
<a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/Software Project/Hostel/hostel/admin/full-profile.php?id=<?php echo $row->id;?>');" title="View Full Details"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
